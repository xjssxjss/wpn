...
public class SmsUtil {
    ...
    public static void getRequest1(){
        ...
        params.put("key",PropertiesListenerConfig.getProperty("sms_appkey"));//应用APPKEY(应用详细页查询)
     ...
     * @param params
     */
    public static String sendSms(Map<String,String> params){
        String result =null;
        String url = PropertiesListenerConfig.getProperty("sms_url");//请求接口地址
        //params.put("mobile","");//接收短信的手机号码
        params.put("key",PropertiesListenerConfig.getProperty("sms_appkey"));//应用APPKEY(应用详细页查询)
        //params.put("dtype","");//返回数据的格式,xml或json，默认json
